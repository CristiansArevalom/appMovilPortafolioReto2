...
public class RegistroPresenter {
    private IRegistroView view; // Interfaz de vista que maneja la interacción con la interfaz de usuario
    ...
    public RegistroPresenter(IRegistroView view, RegistroModel model) {
        this.view = view;
        this.model = model;
    }
